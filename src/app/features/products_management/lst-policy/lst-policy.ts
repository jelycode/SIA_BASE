...
import { DetPolicy } from '../det-policy/det-policy';
...
export class LstPolicy {
  ...
  ngOnInit() {
    this.datosPolizas = [
      ...
      { poliza: '20455', nombre: 'Importadora los Arbolitos',   fechaInicio: new Date(), fechaFin: new Date(), estado: 'NO Vigente' },
  ...
  activeMenuId      = '';
  polizaSeleccionada: any = null;

  cambiarVista(id: string, row?: any) {
    this.activeMenuId       = id;
    this.polizaSeleccionada = row;
  }
}